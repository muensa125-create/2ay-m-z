        ...
        >
          ...
          <div className="bg-[#3D2F3F] p-4 md:p-8 rounded-lg shadow-lg shadow-pink-900/20 mb-6 relative">
            ...
            <p className="text-[#F5E6E6] leading-relaxed font-caveat text-base md:text-xl">
              Benim hayatımda herkes ile yakın arkadaşım arasında dağlar kadar fark vardır derdim; sense geldin ve tek gerçeğim oldun. Mersin-İzmir arasındaki kilometreler, İlyas kuryenin yolu bulamaması, gece yarısı sokakta tok sesli karpuz aramalarımız... Ve 23 Ağustos'ta kurduğumuz o çadır; sıcaktan terleyerek uyusak da, gece ilk defa karanlık denize birlikte atlayıp su tabancasıyla savaştığımızda da anladım: Seninle her an bambaşka bir macera. Yanında değilken bile aklımın her saniye sende olduğunu ve 'Gınnış'ı beraber yapacağımız o günü sabırsızlıkla beklediğimi bil.
            </p>
          </div>
